...
describe('LinksSharePanelComponent', () => {
  ...
  it('gera e exibe QR Code automaticamente quando existe URL publica', fakeAsync(() => {
    ...
    fixture.componentRef.setInput('url', 'https://empresa-de-teste.clickmanager.com.br/links');
    ...
    expect((toDataUrlSpy.calls.mostRecent().args as unknown[])[0]).toBe('https://empresa-de-teste.clickmanager.com.br/links');
