  ...
  ngOnInit(): void {
    ...
    this.route.paramMap.pipe(
      switchMap((params) => {
        ...
        this.formState.begin(this.corId ? 'edit' : 'create');
      ...
      error: (error) => { this.carregando = false; this.toastr.error(catalogoErrorMessage(error, 'Não foi possível carregar a cor.')); },
    });
  }
